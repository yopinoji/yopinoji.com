...
export type RelatedPostsQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id'>
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'slug' | 'title' | 'category' | 'lang' | 'tags'>> }
      ) }> } };
...
export type AllContentsQuery = { allMarkdownRemark: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'slug' | 'template'>> } }> } };

export type AllTagsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllTagsQuery = { allMarkdownRemark: { group: Array<Pick<MarkdownRemarkGroupConnection, 'fieldValue'>> } };

export type AllCategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type AllCategoriesQuery = { allMarkdownRemark: { group: Array<Pick<MarkdownRemarkGroupConnection, 'fieldValue'>> } };

export type CategoriesQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type CategoriesQueryQuery = { allMarkdownRemark: { group: Array<Pick<MarkdownRemarkGroupConnection, 'totalCount' | 'fieldValue'>> } };
...
export type SiteMetadataQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'description' | 'author' | 'email' | 'image' | 'twitterId' | 'githubId' | 'googleAdSense' | 'copyright' | 'lang' | 'charSet'>> }> };

export type TagsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type TagsQueryQuery = { allMarkdownRemark: { group: Array<Pick<MarkdownRemarkGroupConnection, 'fieldValue'>> } };
