...
摂取後に発熱などはなかったのですが、ワクチン注射した左腕の痛みが数日続いて地味にキツかったです。  
...
職務経歴書やレジュメも GitHub に公開しちゃってます。（転職の時に即座に職務経歴を共有できるので便利）

更に言うと、このブログは何故か非エンジニアである親にバレていると言う訳分からん状況になっています。
...
一応、簿記の資格取得用の参考書は買ってはあるので（放置してある）、夏休みの時期にでも勉強を進めたいなと思っているところです。
